...
from .anchor_detr import AnchorDETR, PostProcess
...
def _make_detr(backbone_name: str, dilation=False, num_classes=91, mask=False):
    ...
    transformer = Transformer(d_model=hidden_dim, num_feature_levels=1)
    detr = AnchorDETR(backbone, transformer, num_feature_levels=1, aux_loss=False)
    if mask:
